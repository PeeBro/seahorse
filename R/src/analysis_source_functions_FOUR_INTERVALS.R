  ...
  if (method == "OCR") {
    ...
    sd_errors <- sd_n %>% 
      mutate(Sample           = sd.sample_id,
             ...
             Spare.Resp.Cpcty = sqrt(((sd.Int3^2)+(sd.Int1^2))/2),
             Maximal.Resp     = sqrt(((sd.Int3^2)+(sd.Int4^2))/2),
    ...
    sd_errors <- sd_n %>% 
      mutate(Sample           = sd.sample_id,
             ...
             log.Spare.Resp.Cpcty = sqrt(((sd.Int3^2)+(sd.Int1^2))/2),
             log.Maximal.Resp     = sqrt(((sd.Int3^2)+(sd.Int4^2))/2),
