...
ocr_stats %>% ggplot(aes(x=Group, y=well_mean)) + 
  ...
  geom_point(aes(x=Group, y = replicate_mean, fill = Date), color = "Black", size = 5, shape = 21)+
  theme_minimal()+
