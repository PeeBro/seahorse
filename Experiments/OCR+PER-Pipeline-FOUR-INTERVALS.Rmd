...
```{r echo=FALSE}
data$Bad_Cells %>%  
  kable(caption="Wells with OCR < 10 in the first interval") %>% 
  kable_styling()
...
paste0("Wells removed due lack of usable measurements (Less than six usable wells in any interval)")
unique(sumar$sample_id)
paste0("Wells removed because there are not four intervals")
